...
function Calendar(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_day_picker_1.DayPicker, Object.assign({ showOutsideDays: showOutsideDays, className: (0, utils_1.cn)('p-2 xl:p-3', className), formatters: {
            ...
            IconLeft: (props) => (0, jsx_runtime_1.jsx)(react_icons_1.ChevronLeftIcon, Object.assign({}, props, { className: (0, utils_1.cn)('h-5 w-5', props.className) })),
            IconRight: (props) => (0, jsx_runtime_1.jsx)(react_icons_1.ChevronRightIcon, Object.assign({}, props, { className: (0, utils_1.cn)('h-5 w-5', props.className) }))
        } }, restProps)));
}
